...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WZTransition",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


/// MARK - 基础过渡
SWIFT_CLASS("_TtC12WZTransition21BasePresentTransition")
@interface BasePresentTransition : NSObject
...
SWIFT_CLASS("_TtC12WZTransition26BasePresentationController")
...
SWIFT_CLASS("_TtC12WZTransition28DialogPresentationController")
@interface DialogPresentationController : BasePresentationController
/// dismissalTransitionWillBegin
- (void)dismissalTransitionWillBegin;
/// 如果你不希望被呈现的 View 占据了整个屏幕，可以调整它的frame
@property (nonatomic) CGRect frameOfPresentedViewInContainerView;
- (nonnull instancetype)initWithPresentedViewController:(UIViewController * _Nonnull)presentedViewController presentingViewController:(UIViewController * _Nullable)presentingViewController OBJC_DESIGNATED_INITIALIZER;
@end
...
/// 自定义对话框专场动画
SWIFT_CLASS("_TtC12WZTransition16DialogTransition")
@interface DialogTransition : BasePresentTransition <UIViewControllerAnimatedTransitioning>
/// 转场时间
...
/// MARK - 菜单栏控制器
SWIFT_CLASS("_TtC12WZTransition26MenuPresentationController")
@interface MenuPresentationController : BasePresentationController
- (void)presentationTransitionWillBegin;
@property (nonatomic) CGRect frameOfPresentedViewInContainerView;
- (nonnull instancetype)initWithPresentedViewController:(UIViewController * _Nonnull)presentedViewController presentingViewController:(UIViewController * _Nullable)presentingViewController OBJC_DESIGNATED_INITIALIZER;
@end
...
/// MARK - 自定义菜单专场动画
SWIFT_CLASS("_TtC12WZTransition14MenuTransition")
@interface MenuTransition : BasePresentTransition <UIViewControllerAnimatedTransitioning>
- (NSTimeInterval)transitionDuration:(id <UIViewControllerContextTransitioning> _Nullable)transitionContext SWIFT_WARN_UNUSED_RESULT;
- (void)animateTransition:(id <UIViewControllerContextTransitioning> _Nonnull)transitionContext;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC12WZTransition17WZPresentAnimator")
@interface WZPresentAnimator : NSObject <UIViewControllerTransitioningDelegate>
